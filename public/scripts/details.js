                    ...
                    function createDetailTable() {
                        ...
                        for (let i = 0; i < objs.length; i++) {
                            if (chosenDetail == objs[i].CourseId) {
                                ...
                                let markupBody1 = "<tr><td>" + "Course Name" + "</td><td id='title' name='title'>" + objs[i].Title + "</td></tr>";
                                $("#courseTableBody").append(markupBody1);
                                let markupBody2 = "<tr><td>" + "Category" + "</td><td id='category' name='category'>" + objs[i].Category + "</td></tr>";
                                $("#courseTableBody").append(markupBody2);
                                let markupBody3 = "<tr><td>" + "Location" + "</td><td id='location' name='location'>" + objs[i].Location + "</td></tr>";
                                $("#courseTableBody").append(markupBody3);
                                let markupBody4 = "<tr><td>" + "Start Date" + "</td><td id='startdate' name='startdate'>" + objs[i].StartDate + "</td></tr>";
                                $("#courseTableBody").append(markupBody4);
                                let markupBody5 = "<tr><td>" + "End Date" + "</td><td id='enddate' name='enddate'>" + objs[i].EndDate + "</td></tr>";
                                $("#courseTableBody").append(markupBody5);
                                let markupBody6 = "<tr><td>" + "Days and Time" + "</td><td id='meets' name='meets'>" + objs[i].Meets + "</td></tr>";
                                $("#courseTableBody").append(markupBody6);
                                let markupBody7 = "<tr><td>" + "Class Fee" + "</td><td id='fee' name='fee'>" + objs[i].Fee + "</td></tr>";
                                $("#courseTableBody").append(markupBody7);
                                let markupBody8 = "<tr><td>" + "Students Registered" + "</td><td id='studentCnt' name='studentCnt'></td></tr>";
