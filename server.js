...
app.get(
    ...
    function(req, res) {
        console.log(
            "Got a GET request for categories");
...
app.get(
    ...
    function(req, res) {
        ...
        console.log(
            "Got a GET request for ALL courses");
...
app.get(
    ...
    function(req, res) {
        ...
        console.log(
            "Got a GET request for course " + id);
        let data = fs.readFileSync(__dirname +
            "/data/" +
            "coursesOffered.json",
            'utf8');
...
app.get(
    '/api/courses/bycategory/:id',
    function(req, res) {
        let id = req.params.id;
        console.log(
            "Got a GET request for courses in category " + id);
        let categories = fs.readFileSync(__dirname +
            "/data/" +
            "categories.json",
            'utf8');
        ...
        console.log(
            "Value was : " + id +
            " which matched category " + selectedCategory);
        let data = fs.readFileSync(__dirname +
            "/data/" +
            "coursesOffered.json",
            'utf8');
...
app.post(
    ...
    function(req, res) {
        ...
        fs.writeFileSync(__dirname +
            "/data/" +
            "coursesOffered.json", JSON.stringify(data));
...
app.post(
    '/api/unregister', urlencodedParser,
    function(req, res) {
        ...
        for (
            let i = 0; i < match.Students.length; i++) {
        ...
        console.log(
            "Student " + removedStudent.StudentName +
            " un-enrolled for " + enrollmentRecord.CourseId);
...
app.delete(
    ...
    function(req, res) {
        console.log(
            "Got a DELETE request for student enrollment record");
        console.log(
            "Student " + removedStudent.StudentName +
            " un-enrolled for " + enrollmentRecord.CourseId);
